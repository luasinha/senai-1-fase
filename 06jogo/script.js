...
escolha = prompt("Roque já tem a Jota Qwert confirmada e" +
 ...
 "Roque então se viu em um dilema: nem camarim o evento tem," +
...
escolha = prompt("Roque contou para  as Tias Fofinhas que o evento ainda está engatinhando e" +
 ...
 "contato do grupo de rap dos netos de uma amiga delas." +
 "Elas já viram Yasmina e os Manos se apresentando no aniversário da avó deles e" +
 "acharam muito talentosos e carismáticos, além de muito conectados. Pode ser uma boa" + 
...
escolha = prompt("Roque aceita e marca Yasmina e os Manos em todas as postagens e o" +
 ...
 "ofertas de parceria e patrocínios apareceram. Bandas também."+
...
alert("Roque não entende a intenção de Yasmina," +
 ...
 "Acontece, duas boas bandas tocam," +
...
escolha = prompt("Roque decide arriscar aceitando a desconhecida banda Horrível Trio e o" + 
 ...
 "Coincidentemente," +
 "Jeferson Bezerra, CEO da big tech amazonia, é muito fã do Horrível Trio e" + 
 "adorou o evento. Gostou tanto que fez uma proposta para reprisar o" +
 "evento na rede social que ele está lançando." + 
 "A proposta é financeiramente muito boa, mas Bezerra tem medo de ter" + 
 "problemas de direitos autorais com as" +
 "bandas cover tocando músicas de outras bandas e pede para elas não aparecerem." +
...
alert("Roque resolve não arriscar e não inclui a Horrível Trio no evento."+ 
 ...
 "Dada a repercussão obtida com o público nichado o"+
...
alert("O corte de duas das bandas originais do festival" +
 ...
 "fortemente negativa ninguém mais quer ter seu nome atrelado" +
...
alert("Roque nega a proposta da amazonia porque não quer virar as"+
 ...
 "A veiculação do festival na nova rede social acontece tanto"+ 
